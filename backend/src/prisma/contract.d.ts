...
export type FieldOutputTypes = {
  readonly public: {
    readonly Attendance: {
      ...
      readonly status: 'present' | 'absent' | 'half_day' | 'leave';
    ...
    readonly Drawing: {
      ...
      readonly machineId: CodecTypes['pg/int4@1']['output'] | null;
      ...
      readonly fileType: 'pdf' | 'image' | 'dwg' | 'dxf' | 'other' | null;
      readonly fileSize: CodecTypes['pg/int4@1']['output'] | null;
      readonly drawingDate: CodecTypes['pg/timestamptz-temporal@1']['output'] | null;
      readonly description: CodecTypes['pg/text@1']['output'] | null;
      readonly remarks: CodecTypes['pg/text@1']['output'] | null;
      readonly isConfidential: CodecTypes['pg/bool@1']['output'];
      ...
      readonly approvalRemarks: CodecTypes['pg/text@1']['output'] | null;
      readonly createdAt: CodecTypes['pg/timestamptz-temporal@1']['output'];
      readonly updatedAt: CodecTypes['pg/timestamptz-temporal@1']['output'];
    };
    readonly DrawingRevision: {
      readonly id: CodecTypes['pg/int4@1']['output'];
      readonly drawingId: CodecTypes['pg/int4@1']['output'];
      readonly revision: CodecTypes['pg/text@1']['output'];
      readonly fileName: CodecTypes['pg/text@1']['output'] | null;
      readonly fileUrl: CodecTypes['pg/text@1']['output'] | null;
      readonly fileType: 'pdf' | 'image' | 'dwg' | 'dxf' | 'other' | null;
      readonly fileSize: CodecTypes['pg/int4@1']['output'] | null;
      readonly changeDescription: CodecTypes['pg/text@1']['output'] | null;
      readonly uploadedById: CodecTypes['pg/int4@1']['output'] | null;
      readonly revisionDate: CodecTypes['pg/timestamptz-temporal@1']['output'];
      readonly createdAt: CodecTypes['pg/timestamptz-temporal@1']['output'];
    };
    readonly Employee: {
      readonly id: CodecTypes['pg/int4@1']['output'];
    ...
    readonly Machine: {
      readonly id: CodecTypes['pg/int4@1']['output'];
      readonly machineCode: CodecTypes['pg/text@1']['output'];
      readonly machineName: CodecTypes['pg/text@1']['output'];
      readonly modelNumber: CodecTypes['pg/text@1']['output'] | null;
    ...
    readonly Payment: {
      readonly id: CodecTypes['pg/int4@1']['output'];
      readonly paymentNumber: CodecTypes['pg/text@1']['output'];
      readonly invoiceId: CodecTypes['pg/int4@1']['output'];
      readonly paymentDate: CodecTypes['pg/timestamptz-temporal@1']['output'];
      readonly amount: CodecTypes['pg/numeric@1']['output'];
      readonly paymentMethod: 'cash' | 'bank_transfer' | 'cheque' | 'upi' | 'card' | 'other';
...
export type FieldInputTypes = {
  readonly public: {
    ...
    readonly Drawing: {
      ...
      readonly machineId: CodecTypes['pg/int4@1']['input'] | null;
      ...
      readonly drawingDate: CodecTypes['pg/timestamptz-temporal@1']['input'] | null;
      readonly description: CodecTypes['pg/text@1']['input'] | null;
      readonly remarks: CodecTypes['pg/text@1']['input'] | null;
      readonly isConfidential: CodecTypes['pg/bool@1']['input'];
      readonly status: 'draft' | 'under_review' | 'approved' | 'rejected' | 'superseded';
      ...
      readonly approvalRemarks: CodecTypes['pg/text@1']['input'] | null;
      readonly createdAt: CodecTypes['pg/timestamptz-temporal@1']['input'];
      readonly updatedAt: CodecTypes['pg/timestamptz-temporal@1']['input'];
    };
    readonly DrawingRevision: {
      readonly id: CodecTypes['pg/int4@1']['input'];
      readonly drawingId: CodecTypes['pg/int4@1']['input'];
      readonly revision: CodecTypes['pg/text@1']['input'];
      readonly fileName: CodecTypes['pg/text@1']['input'] | null;
      readonly fileUrl: CodecTypes['pg/text@1']['input'] | null;
      readonly fileType: 'pdf' | 'image' | 'dwg' | 'dxf' | 'other' | null;
      readonly fileSize: CodecTypes['pg/int4@1']['input'] | null;
      readonly changeDescription: CodecTypes['pg/text@1']['input'] | null;
      readonly uploadedById: CodecTypes['pg/int4@1']['input'] | null;
      readonly revisionDate: CodecTypes['pg/timestamptz-temporal@1']['input'];
      readonly createdAt: CodecTypes['pg/timestamptz-temporal@1']['input'];
    };
    readonly Employee: {
      readonly id: CodecTypes['pg/int4@1']['input'];
    ...
    readonly Machine: {
      readonly id: CodecTypes['pg/int4@1']['input'];
      readonly machineCode: CodecTypes['pg/text@1']['input'];
      readonly machineName: CodecTypes['pg/text@1']['input'];
      readonly modelNumber: CodecTypes['pg/text@1']['input'] | null;
    ...
    readonly Payment: {
      readonly id: CodecTypes['pg/int4@1']['input'];
      readonly paymentNumber: CodecTypes['pg/text@1']['input'];
      readonly invoiceId: CodecTypes['pg/int4@1']['input'];
        ...
        readonly entries: {
          readonly table: {
            readonly attendance: {
              ...
              uniques: readonly [{ readonly columns: readonly ['employeeId', 'date'] }];
              indexes: readonly [
                {
                  readonly name: 'attendance_employeeId_idx_087dd4a6';
                  readonly prefix: 'attendance_employeeId_idx';
                ...
                {
                  readonly name: 'attendance_status_idx_e98638ab';
                  readonly prefix: 'attendance_status_idx';
            ...
            readonly drawing: {
              columns: {
                ...
                readonly revision: {
                  ...
                  readonly default: {
                    ...
                    readonly value: DefaultLiteralValue<'pg/text@1', 'A'>;
                  };
                };
                readonly projectId: {
                  readonly nativeType: 'int4';
              ...
              indexes: readonly [
                ...
                {
                  readonly name: 'drawing_machineId_idx_285fc70b';
                  readonly prefix: 'drawing_machineId_idx';
                ...
                {
                  readonly name: 'drawing_drawingNumber_idx_1036d7cf';
                  readonly prefix: 'drawing_drawingNumber_idx';
                  readonly columns: readonly ['drawingNumber'];
                  readonly unique: false;
                },
                {
                  readonly name: 'drawing_drawingDate_idx_c9c722b3';
                  readonly prefix: 'drawing_drawingDate_idx';
                  readonly columns: readonly ['drawingDate'];
                  readonly unique: false;
                },
                {
                  readonly name: 'drawing_isConfidential_idx_4f7ff83f';
                  readonly prefix: 'drawing_isConfidential_idx';
                  readonly columns: readonly ['isConfidential'];
                  readonly unique: false;
                },
                {
                  readonly name: 'drawing_reviewedById_idx_e2835478';
                  readonly prefix: 'drawing_reviewedById_idx';
                  readonly columns: readonly ['reviewedById'];
                  readonly unique: false;
                },
                {
                  readonly name: 'drawing_approvedById_idx_01ef8410';
                  readonly prefix: 'drawing_approvedById_idx';
            ...
            readonly drawingRevision: {
              ...
              primaryKey: { readonly columns: readonly ['id'] };
              uniques: readonly [{ readonly columns: readonly ['drawingId', 'revision'] }];
              indexes: readonly [
                {
                  readonly name: 'drawingRevision_drawingId_idx_940f41d1';
                  readonly prefix: 'drawingRevision_drawingId_idx';
                  readonly columns: readonly ['drawingId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'drawingRevision_uploadedById_idx_b92fad21';
                  readonly prefix: 'drawingRevision_uploadedById_idx';
                  readonly columns: readonly ['uploadedById'];
                  readonly unique: false;
                },
                {
                  readonly name: 'drawingRevision_revisionDate_idx_759f740a';
                  readonly prefix: 'drawingRevision_revisionDate_idx';
                  readonly columns: readonly ['revisionDate'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'drawingRevision';
                    readonly columns: readonly ['drawingId'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
            ...
            readonly machine: {
              ...
              primaryKey: { readonly columns: readonly ['id'] };
              uniques: readonly [{ readonly columns: readonly ['machineCode'] }];
              indexes: readonly [
                {
                  readonly name: 'machine_machineName_idx_dd906e71';
                  readonly prefix: 'machine_machineName_idx';
                  readonly columns: readonly ['machineName'];
                  readonly unique: false;
                },
                {
                  readonly name: 'machine_modelNumber_idx_769da1ec';
                  readonly prefix: 'machine_modelNumber_idx';
                  readonly columns: readonly ['modelNumber'];
                  readonly unique: false;
                },
                {
                  readonly name: 'machine_projectId_idx_a96e4d92';
                  readonly prefix: 'machine_projectId_idx';
                  readonly columns: readonly ['projectId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'machine_isActive_idx_77fe3ba1';
                  readonly prefix: 'machine_isActive_idx';
            ...
            readonly payment: {
              columns: {
                ...
                readonly paymentMethod: {
                  ...
                  readonly default: {
                    readonly kind: 'literal';
                    readonly value: DefaultLiteralValue<'pg/text@1', 'bank_transfer'>;
                  };
                };
              ...
              primaryKey: { readonly columns: readonly ['id'] };
              uniques: readonly [{ readonly columns: readonly ['paymentNumber'] }];
              indexes: readonly [
                {
                ...
                {
                  readonly name: 'payment_paymentMethod_idx_25bac06e';
                  readonly prefix: 'payment_paymentMethod_idx';
                  readonly columns: readonly ['paymentMethod'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [
          ...
          readonly valueSet: {
            readonly AttendanceStatus: {
              ...
              readonly values: readonly ['present', 'absent', 'half_day', 'leave'];
            };
            readonly DrawingFileType: {
              readonly kind: 'valueSet';
              readonly values: readonly ['pdf', 'image', 'dwg', 'dxf', 'other'];
            };
...
> & {
  ...
  readonly roots: {
    ...
    readonly machine: { readonly namespace: 'public' & NamespaceId; readonly model: 'Machine' };
    readonly drawingRevision: {
      readonly namespace: 'public' & NamespaceId;
      readonly model: 'DrawingRevision';
    };
      ...
      readonly public: {
        readonly models: {
          ...
          readonly Drawing: {
            ...
            readonly relations: {
              ...
              readonly revisions: {
                ...
                readonly on: {
                  readonly localFields: readonly ['id'];
                  readonly targetFields: readonly ['drawingId'];
                };
              };
              readonly uploadedBy: {
                readonly to: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly drawingDate: { readonly column: 'drawingDate' };
                readonly description: { readonly column: 'description' };
                readonly remarks: { readonly column: 'remarks' };
                readonly isConfidential: { readonly column: 'isConfidential' };
                readonly status: { readonly column: 'status' };
                ...
                readonly approvalRemarks: { readonly column: 'approvalRemarks' };
                readonly createdAt: { readonly column: 'createdAt' };
                readonly updatedAt: { readonly column: 'updatedAt' };
              };
            };
          ...
          readonly DrawingRevision: {
            ...
            readonly relations: {
              readonly drawing: {
                ...
                readonly cardinality: 'N:1';
                readonly on: {
                  readonly localFields: readonly ['drawingId'];
                  readonly targetFields: readonly ['id'];
                };
              };
              readonly uploadedBy: {
            ...
            readonly storage: {
              readonly table: 'drawingRevision';
              readonly namespaceId: 'public';
              readonly fields: {
                readonly id: { readonly column: 'id' };
                readonly drawingId: { readonly column: 'drawingId' };
                readonly revision: { readonly column: 'revision' };
                readonly fileName: { readonly column: 'fileName' };
                readonly fileUrl: { readonly column: 'fileUrl' };
                readonly fileType: { readonly column: 'fileType' };
                readonly fileSize: { readonly column: 'fileSize' };
                readonly changeDescription: { readonly column: 'changeDescription' };
                readonly uploadedById: { readonly column: 'uploadedById' };
                readonly revisionDate: { readonly column: 'revisionDate' };
                readonly createdAt: { readonly column: 'createdAt' };
              };
            };
          };
          ...
          readonly Machine: {
            ...
            readonly storage: {
              readonly table: 'machine';
              readonly namespaceId: 'public';
              readonly fields: {
                readonly id: { readonly column: 'id' };
                readonly machineCode: { readonly column: 'machineCode' };
                readonly machineName: { readonly column: 'machineName' };
                readonly modelNumber: { readonly column: 'modelNumber' };
          ...
          readonly Payment: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                readonly id: { readonly column: 'id' };
                readonly paymentNumber: { readonly column: 'paymentNumber' };
                readonly invoiceId: { readonly column: 'invoiceId' };
        ...
        readonly enum: {
          ...
          readonly DrawingFileType: {
            ...
            readonly members: readonly [
              ...
              { readonly name: 'DWG'; readonly value: 'dwg' },
              { readonly name: 'DXF'; readonly value: 'dxf' },
